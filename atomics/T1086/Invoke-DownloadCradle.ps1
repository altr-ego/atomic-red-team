...
If ($TLS -eq 0){
    $Url = @(
        "http://127.0.0.1/test.ps1", # Basic Powershell Test script
        "127.0.0.1", # DNS text test - Powershell Test script base64 encoded in DNS txt field
        "http://127.0.0.1/test.xml", # Powershell embedded command
        "http://127.0.0.1/test.sct", # Powershell embedded scriptlet
        "http://127.0.0.1/mshta.sct", # Powershell embedded scriptlet
        "http://127.0.0.1/test.xsl" # Powershell embedded extensible Stylesheet Language
    )
}
ElseIf ($TLS -eq 1){
    # Add https server details here... remember: it is not advised to run other peoples things form the internet!
    $Url = @(
        "https://raw.githubusercontent.com/altr-ego/atomic-red-team/master/atomics/T1086/payloads/test.ps1", # Basic Powershell Test script
        "127.0.0.1", # DNS text test - Powershell Test script base64 encoded in DNS txt field
        "https://raw.githubusercontent.com/altr-ego/atomic-red-team/master/atomics/T1086/payloads/test.xml", # Powershell embedded command
        "https://raw.githubusercontent.com/altr-ego/atomic-red-team/master/atomics/T1086/payloads/test.sct", # Powershell embedded scriptlet
        "https://raw.githubusercontent.com/altr-ego/atomic-red-team/master/atomics/T1086/payloads/mshta.sct", # Powershell embedded scriptlet
        "https://raw.githubusercontent.com/altr-ego/atomic-red-team/master/atomics/T1086/payloads/test.xsl" # Powershell embedded extensible Stylesheet Language
    )
}
